...
function Hero({ onTrackClick }) {
  return (
    <section id="top" className="bcg-hero">
      ...
      />
      <video
        className="bcg-hero-video"
        src="https://media-publications.bcg.com/flash/bcg/Purpose-Film-Brand-Reskin-v4.mp4"
        autoPlay
        loop
        playsInline
        muted
      />
      <div className="bcg-hero-overlay" />
